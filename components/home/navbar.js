...
export default function NavBar({ content }) {
    ...
    return (
        <nav className="flex justify-between sticky top-0 bg-white z-10"> 
            <a href="/"><div className="pl-2 lg:justify-left"><img src='/logo.png' width="100" height="72"/></div></a>
            <div className="pr-3 pt-6 lg:hidden" onClick={() => setOpen(!open)}><img src='/menu.png' width="40" height="30"/></div>
            {open ? <MobileNav /> : null}
