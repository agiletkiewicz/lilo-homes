    ...
    if (flipped) return (
        <div className="relative mt-6 mb-3">
            ...
            <div className="absolute top-0 bottom-0 left-0 right-0 bg-grey opacity-60"></div>
                <div className="p-2 lg:p-5 absolute top-0 bottom-0 left-0 right-0 bg-main-blue m-auto text-left text-xs lg:text-base font-heading text-white" onClick={() => setFlip(false)}>
